  ...
  render() {
    ...
    if(this.props.location.search){
      ...
      let name = this.state.name.split(' '),
          ...
          url= `whatsapp://send?text=तनिक%20देखो%20तो${urName}ने%20आपके%20लिए%20स्वामी%20जी%20की%20कौन%20सी%20अनमोल%20उपहार%20भेजा%20है%20l%20देखने%20के%20लिए%20Click%20करें%20l👇%0A%0Ahttps%3A%2F%2Fwww.story4u.info/sjgd/search?${nameInUri}`;
